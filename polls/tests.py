...
def create_question(question_text, days):
    """
     ...
     количество дней смещения до настоящего момента (отрицательный для вопросов,
     опубликованных в прошлом, положительный для вопросов, которые еще не были опубликованы).
     """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Даже если существуют и прошлые, и будущие вопросы, отображаются только прошлые вопросы.
        """
        create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
...
def test_was_published_recently_with_old_question(self):
    """
    was_published_recently () возвращает False для вопросов, для которых pub_date старше 1 дня.
    """
...
def test_was_published_recently_with_recent_question(self):
    """
    was_published_recently () возвращает True для вопросов, pub_date которых находится в пределах последнего дня.
    """
